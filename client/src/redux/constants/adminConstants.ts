...
export const GET_SERVICE_PREFERENCES_SUCCESS = 'GET_SERVICE_PREFERENCES_SUCCESS'

export const GET_SERVICE_PREFERENCES_FAIL = 'GET_SERVICE_PREFERENCES_FAIL'

export const UPDATE_SERVICE_PREFERENCES_SUCCESS = 'UPDATE_SERVICE_PREFERENCES_SUCCESS'

export const UPDATE_SERVICE_PREFERENCES_FAIL = 'UPDATE_SERVICE_PREFERENCES_FAIL'
