...
const AdminSignIn = () => {
  ...
  const signInError = useSelector((state: ReturnType<typeof rootReducer>) => state.admin?.signInError)
          ...
          <form>
            <div className='w-full mt-4'>
              <input
                ...
                className='block w-full px-4 py-2 mt-2 text-gray-700 placeholder-gray-500 bg-white border rounded-md focus:border-blue-400 focus:'
                type='text'
            ...
            {signInError && (
              <div className='bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded-md relative mt-4 flex items-center justify-center justify-between'>
            ...
            <div className='flex items-center justify-between mt-4'>
              ...
              >
                {signingIn ? <ButtonLoadingSpinner loadingText={'Signing In...'} /> : 'Sign In'}
              </button>
            </div>
          </form>
        </div>
